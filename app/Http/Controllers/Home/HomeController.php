...
class HomeController extends BaseHomController
{
    ...
    public function index()
    {
        ...
        $pd_product_news = Product::searchByCondition(['product_news' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], \CGlobal::num_record_per_page_product_index, 0, $total_product_news);
        $pd_product_most = Product::searchByCondition(['product_most' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], \CGlobal::num_record_per_page_product_index, 0, $total_product_most);
        $pd_product_gif = Gift::searchByCondition(['gift_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], \CGlobal::num_record_per_page_product, 0, $total_product_gif);
        $pd_product_cheapest = Product::searchByCondition(['product_cheapest' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], \CGlobal::num_record_per_page_product_index, 0, $total_product_cheapest);
        $pd_product_buy_most = Product::searchByCondition(['product_buy_most' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], \CGlobal::num_record_per_page_product_index, 0, $total_product_buy_most);
        $pd_product_best = Product::searchByCondition(['product_best' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], \CGlobal::num_record_per_page_product_index, 0, $total_product_best);

        $cate = Category::getAll(['category_parent_id' => Category::getIdByKeyword(\CGlobal::key_danh_muc_dh)], 100);
        $arProductCate = array();
        foreach ($cate as $item) {
            $arp = Product::searchByCondition(['product_cate_id' => $item->category_id, 'product_news' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], \CGlobal::num_record_per_page_row_product_index, 0, $total);
    ...
    {
        \Loader::loadCSS('libs/slick-slider/slick.css', \CGlobal::$postHead);
        \Loader::loadCSS('libs/slick-slider/slick-theme.css', \CGlobal::$postHead);
        \Loader::loadJS('libs/slick-slider/slick.min.js', \CGlobal::$postEnd);
        \Loader::loadJS('backend/js/home.js', \CGlobal::$postEnd);
        ...
        $meta_title = !empty($product) ? $product->meta_title : '';
        $meta_keywords = !empty($product) ? $product->meta_keywords : '';
        $meta_description = !empty($product) ? $product->meta_description : '';
        if (!empty($product)) {
    ...
    public function category(Request $request, $name = '', $id = 0)
    {
        ...
        $meta_title = !empty($cate) ? $cate->meta_title : '';
        $meta_keywords = !empty($cate) ? $cate->meta_keywords : '';
        $meta_description = !empty($cate) ? $cate->meta_description : '';
        if (!empty($cate)) {
        ...
        $total_product_buy_most = 0;
        $total_product_best = 0;
        $pd_product_news = Product::searchByCondition(['product_cate_id' => $cate->category_id, 'product_news' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], $limit, $offset, $total_product_news);
        $pd_product_most = Product::searchByCondition(['product_cate_id' => $cate->category_id, 'product_most' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], $limit, $offset, $total_product_most);
        $pd_product_gif = Gift::searchByCondition(['product_cate_id' => $cate->category_id, 'gift_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], $limit, $offset, $total_product_gif);
        $pd_product_cheapest = Product::searchByCondition(['product_cate_id' => $cate->category_id, 'product_cheapest' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], $limit, $offset, $total_product_cheapest);
        $pd_product_buy_most = Product::searchByCondition(['product_cate_id' => $cate->category_id, 'product_buy_most' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], $limit, $offset, $total_product_buy_most);
        $pd_product_best = Product::searchByCondition(['product_cate_id' => $cate->category_id, 'product_best' => \CGlobal::status_show, 'product_status' => \CGlobal::status_show, 'orderby' => ['product_order_no', 'asc']], $limit, $offset, $total_product_best);
    ...
    public function vote(Request $request)
    {
        ...
        if (!empty($_POST)) {
            $pid = $request->pid;
            $vnum = $request->vnum;
            $ipadr = $request->has('ip')?$request->ip:$request->ip();
            $uid = $request->check;
            if ($pid > 0) {
                $v = VoteProduct::checkVote($pid, $ipadr,$uid);
                if ($vnum > 0 && $ipadr != '') {
                    if (count($v) > 0) {
//                    VoteProduct::updateItem(['vote_ip_address'=>$ipadr,'vote_product_id'=>$pid,'vote_num'=>$vnum],$v[0]['vote_id']);
                    } else {
                        VoteProduct::addItem(['vote_ip_address' => $ipadr, 'vote_product_id' => $pid, 'vote_num' => $vnum, 'vote_created' => time(),'vote_uid'=>$uid]);
                    }
                }
                $n1 = VoteProduct::getByIdProduct($pid, 1);
                $n2 = VoteProduct::getByIdProduct($pid, 2);
                $n3 = VoteProduct::getByIdProduct($pid, 3);
                $n4 = VoteProduct::getByIdProduct($pid, 4);
                $n5 = VoteProduct::getByIdProduct($pid, 5);
                $total = VoteProduct::getByIdProduct($pid, 0);
                $rsp['total'] = $total;
                $rsp['ckv'] = count($v);
                $rsp['nstar'] = sizeof($v)>0?$v[0]['vote_num']:5;
                $rsp['n1'] = ['total' => $n1, 'precent' => round(($n1 / $total) * 100)];
                $rsp['n2'] = ['total' => $n2, 'precent' => round(($n2 / $total) * 100)];
                $rsp['n3'] = ['total' => $n3, 'precent' => round(($n3 / $total) * 100)];
                $rsp['n4'] = ['total' => $n4, 'precent' => round(($n4 / $total) * 100)];
                $rsp['n5'] = ['total' => $n5, 'precent' => round(($n5 / $total) * 100)];
            }
        }
        if (!empty($rsp)) {
