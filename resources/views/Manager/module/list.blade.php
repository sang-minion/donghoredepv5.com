                        ...
                        @foreach($data as $k=>$item)
                            <tr>
                                ...
                                <td>@if($item->module_status == CGlobal::status_show)
                                        <i class="fa fa-circle fa-admin green changestt" dataid="{{$item->module_id}}" datastt="{{$item->module_status}}" datatype="9" datamulti="0" title="click để thay đổi trạng thái"></i>
                                    @else
                                        <i class="fa fa-circle fa-admin red changestt" dataid="{{$item->module_id}}" datastt="{{$item->module_status}}" datatype="9" datamulti="0" title="click để thay đổi trạng thái"></i>
                                    @endif
                                </td>
