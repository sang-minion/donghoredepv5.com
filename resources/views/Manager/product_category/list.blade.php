...
@section('content')
    ...
    <div class="row menu-option">
        <div class="col-lg-6 col-md-6 col-sm-6"><h5>Quản lý: Danh mục sản phẩm [tổng số: {{$total}}]</h5></div>
        <div class="col-lg-6 col-md-6 col-sm-6" style="text-align: right">
            <a href="{{route('admin.product_category_edit')}}"> <i class="fa fa-plus" title="thêm mới"></i> </a>
            <a href="javascript:void(0)"> <i class="fa fa-trash" id="deleteMoreItem" title="xóa item"></i> </a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <form action="{{route('admin.product_category_delete') }}" id="formListItem" name="formListItem" method="POST">
                {{ csrf_field() }}
                        ...
                        @foreach($data as $k=>$item)
                            <tr>
                                ...
                                <td><input class="checkItem" name="checkItem[]" type="checkbox"
										   ...
										   <td><img src="{{ThumbImg::thumbBaseNormal(Category::FOLDER,$item->category_id,$item->category_media,800,600,'',true,true,true)}}"  rel="{{ThumbImg::thumbBaseNormal(Category::FOLDER,$item->category_id,$item->category_media,800,600,'',true,true,true)}}" id="showIMG" style="width:100%; min-width:80px"/></td>		  
                                ...
                                <td><a href="{{route('admin.product_category_edit',['id'=>$item->category_id])}}">
