...
@section('content')
        ...
        <form name="frmSearch" class="frmSearch" id="frmSearch" method="GET">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-3">
                    ...
                    <div>
                        <select name="static_parent_key" class="form-control input-sm">
                            {!! $optionKey !!}
                        </select>
                    </div>
                </div>
    ...
    <div class="row menu-option">
        <div class="col-lg-6 col-md-6 col-sm-6"><h5>Quản lý: Nội dung tĩnh [tổng số: {{$total}}]</h5></div>
        <div class="col-lg-6 col-md-6 col-sm-6" style="text-align: right">
            <a href="{{route('admin.static_edit')}}"> <i class="fa fa-plus" title="thêm mới"></i> </a>
            <a href="javascript:void(0)"> <i class="fa fa-trash" id="deleteMoreItem" title="xóa item"></i> </a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <form action="{{route('admin.static_delete') }}" id="formListItem" name="formListItem" method="POST">
                {{ csrf_field() }}
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($data as $k=>$item)
                            <tr>
                                ...
                                <td>{{isset($arrKey[$item->static_parent_key])?$arrKey[$item->static_parent_key]:'Chưa chọn nội dung'}}</td>
                                ...
                                <td><a href="{{route('admin.static_edit',['id'=>$item->static_id])}}"><i
