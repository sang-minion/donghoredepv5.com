...
<div class="col-md-12 col-sm-12 xol-xs-12 product-center product-row-index">
                            <div class="title-row border-green1">
                                ...
                                <a href="{{Funclip::buildLinkCategory($Cate->category_id,$Cate->category_keyword)}}"
                                   class="btn green1 btn-show-all hidden-xs" title="{{$Cate->category_title}}">Xem
                                    tất
                                    cả</a>
                            </div>
                            <div class="product-row product-row-left">
                                <div class="col-large">
                                    <a href="{{Funclip::buildLinkCategory($Cate->category_id,$Cate->category_keyword)}}"
								...
								<div class="col-item">
								@include('home.partical_list_product',['listPD'=>$listPD])                               
								</div>
						   </div>
                        </div>