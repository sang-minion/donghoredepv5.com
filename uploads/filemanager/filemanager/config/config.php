...
|
*/
if(isset($_SESSION['user'])&&$_SESSION['user']['allow_upload']==1){
...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/uploads/filemanager',
    /*'base_url'=>'http://localhost:8000/gitHub/donghoredep.com5/uploads/filemanager/',*/
	/*
	|--------------------------------------------------------------------------
